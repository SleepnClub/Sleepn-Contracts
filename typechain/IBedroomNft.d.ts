...
interface IBedroomNftInterface extends ethers.utils.Interface {
  functions: {
...
export class IBedroomNft extends BaseContract {
  ...
  interface: IBedroomNftInterface;
  ...
  functions: {
    ...
    getNftOwnership(
      ...
      [
        ...
        _infos: [string, BigNumber, BigNumber, BigNumber, number] & {
          owner: string;
          price: BigNumber;
          designId: BigNumber;
          level: BigNumber;
