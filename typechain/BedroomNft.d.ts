...
interface BedroomNftInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getNftOwnership(uint256)": FunctionFragment;
    "getNftSpecifications(uint256)": FunctionFragment;
    "isApprovedForAll(address,address)": FunctionFragment;
    "mintingBedroomNft(uint256,uint256,uint8,address)": FunctionFragment;
    ...
    "upgradeBedroomNft(uint256,uint256,uint256,uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getNftOwnership",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export type BedroomNftMintingEvent = TypedEvent<
  [
    ...
    [
      ...
      circadianRhythmRegulation: BigNumber;
      sizeScore: BigNumber;
...
export class BedroomNft extends BaseContract {
  ...
  functions: {
    ...
    upgradeBedroomNft(
      _tokenId: BigNumberish,
      _attributeIndex: BigNumberish,
      _valueToAdd: BigNumberish,
